...
import { AddTestSeries } from '../../components/Modals/Modals';
...
const TestSeries = () => {
    ...
    const fetchData = useCallback(async () => {
        setData([])
        await getApi(endPoints.getAllTestSeries(pagination.page, pagination.limit, searchQuery), {
            setResponse: setData,
