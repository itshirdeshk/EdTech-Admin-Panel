...
import { AddSubExams } from '../../components/Modals/Modals';
...
const AllSubExams = () => {
    ...
    const fetchData = useCallback(async () => {
        setData([])
        await getApi(endPoints.getAllSubExams(pagination.page, pagination.limit, searchQuery), {
            setResponse: setData,
    ...
    const handleDelete = async (categoryId) => {
        ...
        await deleteApi(endPoints.deletesubExam(categoryId), {
            setLoading,
...
export default HOC(AllSubExams)